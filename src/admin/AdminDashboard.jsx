...
import React, { useEffect, useState } from "react";
import axiosInstance from "../utils/axiosInstance"; // use axiosInstance with JWT
import {
  PieChart, Pie, Cell, Tooltip, Legend,
  BarChart, Bar, XAxis, YAxis, CartesianGrid, ResponsiveContainer,
} from "recharts";
import { Users, ShoppingCart, PackageCheck, PackageX, Truck, Ban } from "lucide-react";
...
const AdminDashboard = () => {
  ...
  const fetchData = () => {
    axiosInstance.get("adminpanel/users/")
      .then(res => setUsers(res.data))
      .catch(err => console.error("Error fetching users:", err));

    axiosInstance.get("adminpanel/products/")
      .then(res => setProducts(res.data))
      .catch(err => console.error("Error fetching products:", err));

    axiosInstance.get("adminpanel/orders/")
