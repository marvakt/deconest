...
//             <h2 className="text-4xl font-light text-gray-900 sm:text-5xl">My Orders</h2>
...
//               <p className="text-gray-600 font-light">Your purchases will appear here once you place an order.</p>
//             </div>
//           ) : (
...
//                               <button
//                                 onClick={() =>
//                                   window.open(`/productDetails/${item.product_id}`, "_blank")
//                                 }
//                                 className="text-pink-600 hover:text-pink-800 text-xs font-medium mt-1"
//                               >
//                                 View Details
//                               </button>
//                             </div>
...
const MyOrders = () => {
  ...
  const getImageUrl = (imageUrl) => {
    ...
    // If it starts with media/ (without leading slash), prepend BASE_URL with slash
    if (imageUrl.startsWith("media/")) {
      return `${BASE_URL}/${imageUrl}`;
    }
