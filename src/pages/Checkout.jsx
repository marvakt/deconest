...
const Checkout = () => {
  ...
  // ✅ Correct total calculation using product.price
  ...
  const handleConfirmOrder = async () => {
    ...
    try {
      ...
      // Save full backend order for summary page
                  ...
                  <div key={index} className="flex items-start border-b border-gray-100 pb-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-900">
                        ₹{(Number(item.product?.price || 0) * Number(item.quantity)).toLocaleString("en-IN")}
                      </p>
                    </div>
                  </div>
                ))}
