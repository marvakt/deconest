    ...
    const fetchLatestOrder = async () => {
      if (token) {
        try {
          ...
          const localOrder = JSON.parse(localStorage.getItem("latestOrder"));
  ...
  return (
    <div className="bg-gradient-to-br from-stone-50 to-amber-50 min-h-screen flex flex-col">
      ...
      <div className="flex-grow px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden border border-stone-100 animate-slide-up">
          {/* Order Header */}
          <div className="bg-gradient-to-r from-stone-800 to-stone-700 p-6 text-white flex justify-between">
            <div>
              <h2 className="text-2xl font-light mb-1">Order Summary</h2>
              <p className="text-stone-200 text-sm">
          ...
          <div className="p-8 mb-6">
            <h3 className="text-xl font-medium text-stone-800 mb-2">Shipping Address</h3>
            <div className="bg-gradient-to-r from-stone-50 to-amber-50 p-4 rounded-2xl border-2 border-stone-100">
              <p className="text-stone-700 leading-relaxed">{order.address}</p>
            </div>
          </div>
          ...
          {/* Ordered Items */}
          <div className="p-8 mb-6">
            <h3 className="text-xl font-medium text-stone-800 mb-4">Ordered Items</h3>
            <div className="space-y-4">
              {order.items.map((item, index) => (
                <div
                  key={index}
                  className="group bg-stone-50 rounded-2xl p-6 border border-stone-100 hover:border-stone-200 hover:bg-gradient-to-r hover:from-stone-100 hover:to-amber-50 transition-all duration-500 transform hover:scale-[1.01]"
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  <div className="flex items-start gap-6">
                    <div className="relative overflow-hidden rounded-xl flex-shrink-0">
                    ...
                    <div className="flex-grow">
                      <h4 className="font-semibold text-stone-800 text-lg mb-2">{item.title}</h4>
                      <div className="flex items-center justify-between">
          ...
          <div className="p-8 flex flex-col gap-4">
            ...
            <div className="flex justify-between text-stone-900 font-bold text-xl border-t border-stone-300 pt-2 mt-2">
              <span>Total:</span>
              <span>₹{order.total.toLocaleString()}</span>
            </div>

            <div className="mt-4 p-4 bg-green-50 rounded-2xl border border-green-200">
              <span className="font-medium text-green-800">Payment Method: Cash on Delivery</span>
            </div>
          </div>
          ...
          <div className="text-center mb-8">
            <button
              onClick={() => navigate("/")}
              className="bg-gradient-to-r from-stone-800 to-stone-700 hover:from-stone-700 hover:to-stone-600 text-white px-12 py-4 rounded-2xl font-semibold text-lg transition-all duration-500 transform hover:scale-105"
            >
              Continue Shopping
            </button>
          </div>
